...
public class VentanaPrincipal extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtPago, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        int numero_inscripcion = Integer.parseInt(txtNumero.getText());
        String nombre = txtNombre.getText();
        double patrimonio = Double.parseDouble(txtPatrimonio.getText());
        int estrato = Integer.parseInt(txtEstrato.getText());
        
        Matricula matricula = new Matricula(numero_inscripcion, nombre, patrimonio, estrato);
        
        double pago_matricula = matricula.getPago_matricula();
        
        txtPago.setText(String.valueOf(pago_matricula));
